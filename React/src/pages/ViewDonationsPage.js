    ...
    <NavigationBar showSearch={true} />
      ...
      <header className="text-center mt-12 mb-6 pt-10">
...

		{
			dons.map(
				donation =>
				<div key={donation.idDonation} className="bg-white rounded-lg shadow-md p-6 mb-4 border border-gray-200 w-9/12 min-w-max mx-auto">
					...
					<p className="text-gray-600 text-sm">
						...
						{new Date(donation.donationTime).toLocaleString()} {/* Formats the date and time nicely */}
					</p>
				</div>
			)
		}
