...
public class DonationDTO {
    ...
    public DonationDTO(Integer idDonation, Integer idAction, String actionName, String userDisplayName, Float amount, LocalDateTime donationTime, Boolean refunded) {
